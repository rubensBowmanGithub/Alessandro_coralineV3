...
public class HadoopConfigConstants {
  ...
  /**
   * Used in cor.properties as stage config property. If set to true, then Hadoop components will always impersonate
  ...
  /**
   * Used in cor.properties as stage config property. If set to true, then user name will be lower cased when used
   * when impersonated.
   */
