...
public class DataParserFormatConfig implements DataFormatConfig {
  ...
  @ConfigDef(
      ...
      description = "Protobuf Descriptor File (.desc) path relative to COR resources directory",
      displayPosition = 600,
      displayMode = ConfigDef.DisplayMode.BASIC,
      group = "DATA_FORMAT",
      dependsOn = "dataFormat^",
  ...
  // It is equal to the max number of runners in multi-threaded pipelines configured in cor.properties,
