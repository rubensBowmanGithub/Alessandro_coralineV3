...
public enum Errors implements ErrorCode {
  ...
  SPOOLDIR_37("Batch size greater than maximal batch size allowed in cor.properties, maxBatchSize: {}"),
  SPOOLDIR_38("Base directory does not have read access permission."),
  ;
