 ...
 */
describe('Controller: modules/coralineConfiguration/coralineConfigurationController', function () {

  beforeEach(module('commonUI.coralineConfiguration'));
  ...
  it('calls configuration init method', function () {
    ...
    var controller = $controller('coralineConfigurationController', {
      $scope: $scope,
      $rootScope: {},
      $q: $q,
      Analytics: Analytics,
