...
public abstract class RuntimeInfo {
  ...
  public static final String SDC_PRODUCT = "cor";
  ...
  // _coraline sets the 'sdc.asterClientLib.dir' system property to the directory containing the aster-client JARs
   ...
   * loaded on data collector start and will override any configuration from cor.properties.
   *
