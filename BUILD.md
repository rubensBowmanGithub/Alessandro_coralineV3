...
`dist/target/streamsets-datacollector-3.22.2/streamsets-datacollector-3.22.2/bin/coraline dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-3.22.2/streamsets-datacollector-3.22.2/bin/coraline cli`
...
`streamsets-datacollector-all-3.22.2-CATALOG/bin/coraline dc`
...
`streamsets-datacollector-all-3.22.2/bin/coraline dc`
