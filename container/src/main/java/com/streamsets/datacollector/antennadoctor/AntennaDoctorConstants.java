...
public final class AntennaDoctorConstants {
  ...
  /**
   * cor.properties config to enable/disable Antenna Doctor functionality.
   */
  public final static String CONF_ENABLE = "antennadoctor.enable";
  public final static boolean DEFAULT_ENABLE = true;

  /**
   * cor.properties config to enable scanning for special override file that will be auto-loaded every 5 seconds.
   */
  ...
  /**
   * cor.properties config to enable downloading updates to the knowledge base.
   */
  ...
  /**
   * cor.properties config for initial delay (in minutes) of when to ask for updates after SDC start.
   */
  public final static String CONF_UPDATE_DELAY = "antennadoctor.update.delay";
  public final static int DEFAULT_UPDATE_DELAY = 5;

  /**
   * cor.properties config for period between asking for updates (in minutes).
   */
