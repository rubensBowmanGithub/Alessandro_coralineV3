...
public class MetadataGeneratorMain {
  ...
  public static void main(String[] args) {
    System.setProperty("cor.conf.dir", System.getProperty("user.dir"));
  ...
  public static abstract class MetadataCommand implements Runnable {
    ...
    protected List<ClassLoader> getClassLoaders() throws Exception {
      String streamsetsLibs = System.getProperty("cor.libraries.dir");
      if (streamsetsLibs == null) {
        System.err.println("ERROR: Missing 'cor.libraries.dir' system properties");
        System.exit(1);
      }
